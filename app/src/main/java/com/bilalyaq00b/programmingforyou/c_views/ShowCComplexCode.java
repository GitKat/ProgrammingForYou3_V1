...
public class ShowCComplexCode extends AppCompatActivity {
    int size = 10;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(intValue){
            case 0:
                setTitle("How to use complex numbers in c");
            ...
            case 1:
                setTitle("C program to printf complex numbers");
                imageView.setImageResource(R.drawable.c_h1);
            ...
            case 2:
                setTitle("Adding two complex numbers in c");
                imageView.setImageResource(R.drawable.c_h1);
