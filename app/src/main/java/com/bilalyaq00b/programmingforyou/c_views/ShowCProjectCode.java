...
public class ShowCProjectCode extends AppCompatActivity {
    int size = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(intValue){
            case 0:
                ...
                imageView.setImageResource(R.drawable.c_h1);  String formattedText = getString(R.string.CprojectSnakeGame);
            ...
            case 2:
                setTitle("Solved Programming Assignment 3");
            ...
            case 16:
                setTitle("Boolean Function Using Multiplexer Logic");
                imageView.setImageResource(R.drawable.c_h1);  String formattedText16 = getString(R.string.CProjectProgToImplementABooleanFunctionUsingAMultiplexerLogic);
                Spanned result16 = Html.fromHtml(formattedText16);
                view.setText(result16);
                break;

            case 17:
                setTitle("Transformation 2D Scaling, Translation, Rotation");
                imageView.setImageResource(R.drawable.c_h1);  String formattedText17 = getString(R.string.CProjectTransformation2DScalingTranslationRotation);
